...
a.describe("parley.providers.vcs.git diffview_range", function()
  a.it("builds an origin/base...head range with --imply-local", function()
    local git = require("parley.providers.vcs.git")
    assert.same({ "origin/main...abc123", "--imply-local" }, git.diffview_range("main", "abc123"))
  end)
end)
