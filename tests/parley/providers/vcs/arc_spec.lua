...
a.describe("parley.providers.vcs.arc diffview_range", function()
  a.it("returns nil: Arc has no diffview.nvim equivalent", function()
    local arc = require("parley.providers.vcs.arc")
    assert.is_nil(arc.diffview_range("trunk", "abc123"))
  end)
end)
