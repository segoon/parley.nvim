...
| Comment actions | Reply, edit, delete, react, resolve, reopen, and open canonical thread or comment links | Resolution requires a GraphQL thread ID from a successful discussion fetch |
